def main():   
    ...
    test_data = pd.read_csv("../../datasets/electricity/val.csv", index_col="date")
    ...
    test_dataset_14 = get_dataset(test_data, indices=list(range(test_data.shape[0], test_data.shape[0] - 14*prediction_length, -prediction_length)))
